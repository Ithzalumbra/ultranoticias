    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('id_user_comment') ?></th>
                <th scope="col"><?= $this->Paginator->sort('id_news') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($comment->id_user_comment) ?></td>
                <td><?= $this->Number->format($comment->id_news) ?></td>
                <td class="actions">
